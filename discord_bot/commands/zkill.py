...
from utils.esi import get_type_name, get_system_name, get_character_name, get_corp_name, get_alliance_name
...
async def fetch_kills():
    async with aiohttp.ClientSession() as session:
        ...
        for eve_id, data in list(ZKILL_DATA.items()):
            ...
            if type_eve_id == 1:
                zkill_kill_url_1 = f"{ZKILL_API}/kills/characterID/{eve_id}/"
                zkill_kill_url_2 = f"{ZKILL_API}/losses/characterID/{eve_id}/"
            elif type_eve_id == 2:
                zkill_kill_url_1 = f"{ZKILL_API}/kills/corporationID/{eve_id}/"
                zkill_kill_url_2 = f"{ZKILL_API}/losses/corporationID/{eve_id}/"
            elif type_eve_id == 3:
                zkill_kill_url_1 = f"{ZKILL_API}/kills/allianceID/{eve_id}/"
                zkill_kill_url_2 = f"{ZKILL_API}/losses/allianceID/{eve_id}/"
